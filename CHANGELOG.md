...
- A patch written out as text follows its own chain, with what the chain reads in the brackets, keeps its arithmetic as arithmetic, and names a sum after what it drives.
