...
void main()
{
    ...
    vec2 w18 = dml(vec2(r17, 0.0), vec2(r16, 0.0)); float r18 = w18.x + w18.y;
    vec2 w19 = dad(w18, w0); float r19 = w19.x + w19.y;
    vec2 w20 = dml(w19, vec2(r5, 0.0)); float r20 = w20.x + w20.y;
