...
void main()
{
    ...
    float r13 = r12 + r6;
    float r14 = uK[4];
    vec2 w15 = vec2(uTime, uTimeLo); float r15 = w15.x + w15.y;
    float r16 = uK[5];
    vec2 w17 = dml(w15, vec2(r16, 0.0)); float r17 = w17.x + w17.y;
    vec2 w18 = dad(dml(vec2(r1, 0.0), vec2(r14, 0.0)), w17); float r18 = w18.x + w18.y;
    vec2 w19 = dml(w18, vec2(r9, 0.0)); float r19 = w19.x + w19.y;
    float r20 = sin(dtr(w19));
    float r21 = r20 * r7;
    float r22 = r21 + r6;
    float r23 = r13 + r22;
    float r24 = uK[6];
    ...
    float r26 = r23 - r24;
    float r27 = r25 - r24;
    float r28 = dv(r26, r27);
    float r29 = r6 + (r7 - r6) * r28;
    float r30 = uK[8];
