...
void main()
{
    ...
    float r2 = uK[1];
    float r3 = uK[2];
    vec2 w4 = dml(w0, vec2(r1, 0.0)); float r4 = w4.x + w4.y;
    float r5 = uK[3];
    float r6 = dmd(w4, vec2(r5, 0.0));
    float r7 = floor(r6);
    float r8 = dfr(w4);
    float r9 = dv(r7, r5);
    float r10 = uK[4];
    ...
    float r67 = uK[11];
    float r68 = uK[12];
    float r69 = clamp(r3, r67, max(r67, r68));
    float r70 = clamp(r2, r11, max(r11, r10));
    float r71 = sm(r11, r69, r8);
    float r72 = r70 - r69;
    float r73 = sm(r72, r70, r8);
    float r74 = r10 - r73;
    float r75 = r66 * r71;
    float r76 = r75 * r74;
    float r77 = uK[13];
    ...
    float r85 = r9 - r11;
    float r86 = r10 - r11;
    float r87 = dv(r85, r86);
    float r88 = r83 + (r84 - r83) * r87;
    float r89 = sqrt(r78 * r78 + r79 * r79);
    float r90 = r89 * r88;
    float r91 = r90 + r11;
    float r92 = uK[16];
    float r93 = r91 * r92;
    ...
    float r97 = r94 - r95;
    float r98 = r10 - r95;
    float r99 = dv(r97, r98);
    float r100 = r96 + (r10 - r96) * r99;
    float r101 = uK[19];
    float r102 = r76 - r11;
    float r103 = r10 - r11;
    float r104 = dv(r102, r103);
    float r105 = r101 + (r10 - r101) * r104;
    float r106 = r100 * r105;
    vec3 t107 = hsv(r9, r77, r106);
    float r107 = t107.x; float r108 = t107.y; float r109 = t107.z;

    fragColor = vec4(sat(r107), sat(r108), sat(r109), 1.0);
}
