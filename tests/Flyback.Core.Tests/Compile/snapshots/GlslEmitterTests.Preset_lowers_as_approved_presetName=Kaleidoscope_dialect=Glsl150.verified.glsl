...
void main()
{
    ...
    float r14 = r12 + r13;
    float r15 = uK[1];
    float r16 = sqrt(r11 * r11 + r14 * r14);
    float r17 = at2(r14, r11);
    float r18 = uK[2];
    float r19 = dv(r18, r15);
    float r20 = uK[3];
    float r21 = r19 * r20;
    float r22 = md(r17, r19);
    float r23 = r22 - r21;
    float r24 = abs(r23);
    float r25 = cos(r24);
    float r26 = r25 * r16;
    ...
    fragColor = vec4(sat(r37), sat(r38), sat(r39), 1.0);
}
