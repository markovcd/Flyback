...
void main()
{
    ...
    float r17 = r14 * r15;
    vec3 t18 = fb(r16, r17);
    float r18 = t18.x; float r19 = t18.y; float r20 = t18.z;
    float r21 = uK[2];
    float r22 = uK[3];
    float r23 = r18 * r21;
    float r24 = r19 * r21;
    ...
    float r32 = uK[6];
    float r33 = uK[7];
    float r34 = sqrt(r0 * r0 + r1 * r1);
    float r35 = r34 * r33;
    float r36 = r35 + r30;
    float r37 = uK[8];
    float r38 = r36 * r37;
    float r39 = sin(r38);
    float r40 = sm(r32, r31, r39);
    vec3 t41 = hsv(r30, r31, r40);
    float r41 = t41.x; float r42 = t41.y; float r43 = t41.z;
    ...
    fragColor = vec4(sat(r44), sat(r45), sat(r46), 1.0);
}
