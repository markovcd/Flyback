...
void main()
{
    ...
    float r9 = r0 * r8;
    float r10 = r1 * r8;
    float r11 = nzw(vec2(r9, 0.0), vec2(r10, 0.0), w7);
    float r12 = uK[2];
    float r13 = uK[3];
    float r14 = uK[4];
    float r15 = uK[5];
    ...
    float r20 = uK[6];
    float r21 = uK[7];
    vec2 w22 = dml(vec2(r20, 0.0), vec2(r21, 0.0)); float r22 = w22.x + w22.y;
    float r24 = uK[8];
    vec2 w25 = dad(dml(w5, w22), vec2(r12, 0.0)); float r25 = w25.x + w25.y;
    float r26 = dfr(w25);
