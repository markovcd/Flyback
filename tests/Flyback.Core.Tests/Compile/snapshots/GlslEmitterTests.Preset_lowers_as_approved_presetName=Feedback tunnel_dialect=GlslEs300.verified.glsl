...
void main()
{
    ...
    float r18 = r15 * r16;
    vec3 t19 = fb(r17, r18);
    float r19 = t19.x; float r20 = t19.y; float r21 = t19.z;
    float r22 = uK[2];
    float r23 = uK[3];
    float r24 = r19 * r22;
    float r25 = r20 * r22;
    ...
    float r33 = uK[6];
    float r34 = uK[7];
    float r35 = sqrt(r0 * r0 + r1 * r1);
    vec2 w36 = dml(vec2(r35, 0.0), vec2(r34, 0.0)); float r36 = w36.x + w36.y;
    vec2 w37 = dad(w36, w31); float r37 = w37.x + w37.y;
    float r38 = uK[8];
    vec2 w39 = dml(w37, vec2(r38, 0.0)); float r39 = w39.x + w39.y;
    float r40 = sin(dtr(w39));
    float r41 = sm(r33, r32, r40);
    vec3 t42 = hsv(r31, r32, r41);
    float r42 = t42.x; float r43 = t42.y; float r44 = t42.z;
    float r45 = max(r27, r42);
    float r46 = max(r28, r43);
    float r47 = max(r29, r44);

    fragColor = vec4(sat(r45), sat(r46), sat(r47), 1.0);
}
