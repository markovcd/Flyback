...
void main()
{
    ...
    float r36 = uK[6];
    vec2 w37 = dml(w5, vec2(r36, 0.0)); float r37 = w37.x + w37.y;
    vec2 w38 = dad(vec2(r35, 0.0), w37); float r38 = w38.x + w38.y;
    float r39 = dfr(w38);
    float r40 = uK[7];
    float r41 = uK[8];
    float r42 = r35 * r21;
    ...
    vec2 w49 = dml(vec2(r48, 0.0), vec2(r47, 0.0)); float r49 = w49.x + w49.y;
    vec2 w50 = dad(w49, w37); float r50 = w50.x + w50.y;
    vec2 w51 = dml(w50, vec2(r19, 0.0)); float r51 = w51.x + w51.y;
    float r52 = sin(dtr(w51));
