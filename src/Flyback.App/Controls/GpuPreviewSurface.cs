...
/// shader and evaluated per pixel by the hardware built for it, which is what
/// stops the frame cost climbing with the size of the patch.
/// </summary>
/// <remarks>
/// ADR-0018's rule — never render a frame on the UI thread — holds by a different
/// mechanism: <see cref="OnOpenGlRender"/> runs on the compositor's render thread
