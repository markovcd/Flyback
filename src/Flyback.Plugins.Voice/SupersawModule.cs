...
internal static class SupersawModule
{
    ...
    public const string TypeId = "flyback.voice.osc";

    public static NodeDef Definition { get; } = new(
        TypeId, "Supersaw", ModuleCategories.Oscillators,
        [
            ...
            new PortSpec("amp", PortKind.Scalar, 1f, 0f, 2f) { Standard = true },
            new PortSpec("bias", PortKind.Scalar, 0f, -2f, 2f) { Standard = true },
        ],
        [
