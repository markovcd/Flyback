...
/// <summary>
/// What a picture is colored with, and what is done to it afterwards.
/// </summary>
/// <remarks>
/// The catalogue had five color modules, and between them they could build a
/// color, take one apart into channels, blend two and multiply one. What they
/// could not do was choose a color well, read one back, or change one after the
/// fact — so every picture the machine made was colored the same way, by putting
...
/// and a palette walks a handful of colors that are neighbours. <b>To HSV</b> is
...
/// second color section would be a worse palette than a longer one.
/// </para>
/// </remarks>
public sealed class ColorPlugin : IFlybackPlugin
{
    internal static ModuleProvider Provider { get; } = new("flyback.color", "Color");
