...
internal static class EchoModule
{
    ...
    public static NodeDef Definition { get; } = new(
        ...
        [
            new PortSpec("in", PortKind.Scalar, 0f, -1f, 1f) { Help = "The sound to echo on the beat." },
        ...
        [
            new PortSpec("left") { Help = "The sound and the left tap's repeats." },
            new PortSpec("right") { Help = "The sound and the right tap's repeats." },
        ],
        Emit,
