...
internal static class Sweep
{
    ...
    public static PortSpec Depth(float value) =>
        new("depth", PortKind.Scalar, value, 0f, 1f) { Standard = true };
    ...
    public static PortSpec Mix(float value) =>
        new("mix", PortKind.Scalar, value, 0f, 1f) { Standard = true };
    ...
    public static PortSpec Motion => new("lfo") { Standard = true };
}
