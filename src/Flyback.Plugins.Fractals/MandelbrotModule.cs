...
internal static class MandelbrotModule
{
    ...
    public static NodeDef Definition { get; } = new(
        ...
        [
            ...
            new PortSpec("re", PortKind.Scalar, Middle, -2f, 1f),
            new PortSpec("im", PortKind.Scalar, 0f, -1.5f, 1.5f),
        ...
        Emit,
        "The Mandelbrot set, the map of every c. 're' and 'im' are the c in the middle of the "
        + "picture, and 'zoom' halves the view each step, so a steady ramp is a steady dive; past "
        + "12 it turns to blocks. 'color' is the classic gradient, navy through white and gold, "
        + "with the set black; 'shift' turns it, and a clock on it cycles the colors. 'escape' is "
        + "how long each point took to run away, smooth and 0 to 1, for a Palette of your own; "
        + "'inside' is 1 on the set. The iteration count is set on the node: deeper zooms need "
        + "more, and each costs about a dozen ops.")
    {
        Extras = [Escape.Extra],
