# ADR-0148: The window is two hubs and the regions around them
...
own, hubs first and the inspector last. Until the last one moves the window is
part partial files and part classes, which is the shape 0039's amendments had
already started.
