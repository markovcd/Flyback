...
If it is missing, make a new one without asking: `. ./release-key.sh` does it, and so does a Release run of the site. Never ask for the real release key and never put it in the variable.
